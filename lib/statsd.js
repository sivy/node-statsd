 ...
 *   @option maxBatchSize  {Integer} Maximum number of messages in a batch
 * @constructor
 */
var Client = function (host, port, prefix, suffix, globalize, cacheDns, mock, global_tags, batch, maxBatchDelay, maxBatchSize) {
  var options = host || {},
         self = this;
